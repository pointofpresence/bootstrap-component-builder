...
/**
 * @description Based on http://tools.arantius.com/tabifier
 */
define("lib/Taber", [], function () {
    "use strict";

    var level = 0;

    function runTabifier(code) {
    ...
    var ownLine = [
        'area', 'body', 'head', 'hr', 'i?frame', 'link', 'meta',
    ...
    var newLevel = [
        'blockquote', 'div', 'dl', 'fieldset', 'form', 'frameset',
